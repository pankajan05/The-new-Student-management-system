...
<?php 
			...
			$query_select = "SELECT * from courses c,enrollment e,exam x WHERE c.course_id=e.course_id and e.exam_id = x.exam_id";
...
$resultcheck = mysqli_num_rows($result);
		...
		<thead>
		  ...
		  while ($result1 = mysqli_fetch_assoc($result)) {	
              echo"<tr><td><input class=\"form-control\" type=\"text\"  name=\"course_name$i\" value=\"".$result1['course_name']."\"></td>
                       <td><input class=\"form-control\" type=\"text\"  name=\"exam_id$i\" value=\"".$result1['exam_id']."\"></td>
                       <td><input class=\"form-control\" type=\"text\"  name=\"student_id$i\" value=\"".$result1['student_id']."\"></td>
                       <td><input class=\"form-control\" type=\"text\"  name=\"marks$i\" value=\"".$result1['marks']."\"></td>
                       <td><input class=\"form-control\" type=\"text\"  name=\"semester_id$i\" value=\"".$result1['semester_id']."\"></td>
              ...
              echo"</table>";
               ...
               if(isset($_POST['update'.$i.''])){
                            ...
                            $exam_id = mysqli_real_escape_string($con,$_POST['exam_id'.$i.'']);
                            $marks = $_POST['marks'.$i.''];
